<section class="Flex JustifyContent-center MarginTop-2xlarge MarginBottom MarginTopMobile-large">
    <section class="HomeChoose">
        <div class="Montserrat-bold Font-24 Padding MarginTop TextAlign-left MarginBottom"> Our Service </div>
        
        <div class="Flex JustifyContent-between FlexDown MarginBottom">
